...
void streamToast(BuildContext context) async {
  // gamestate stream listener
  Future<void> listenGameStateStream() async {
      ...
      switch (update.gameState.type) {
        case GameStateUpdateType.MarketStateUpdate:
          if (update.gameState.marketState.isMarketOpen) {
            ...
            showSnackBar(
                context, 'Dalal Street Stock Market is closed right now',
                type: SnackBarType.success);
          }
          break;
  ...
  Future<void> listenNotificationStream() async {
  ...
  Future<void> listenTransactionStream() async {
