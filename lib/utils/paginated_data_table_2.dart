...
class PaginatedDataTable2 extends StatefulWidget {
  ...
  final ValueChanged<int>? handlePrevious;
  final ValueChanged<int>? handleNext;
...
class PaginatedDataTable2State extends State<PaginatedDataTable2> {
  ...
  void _handlePrevious() {
    widget.handlePrevious == null
        ? {pageTo(math.max(_firstRowIndex - widget.rowsPerPage, 0))}
        : {
            widget.handlePrevious!(_firstRowIndex),
            pageTo(math.max(_firstRowIndex - widget.rowsPerPage, 0))
          };
  }

  void _handleNext() {
    widget.handleNext == null
        ? {pageTo(_firstRowIndex + widget.rowsPerPage)}
        : {
            widget.handleNext!(_firstRowIndex),
            pageTo(_firstRowIndex + widget.rowsPerPage)
          };
  }
