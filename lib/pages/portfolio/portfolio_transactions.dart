      ...
      BlocBuilder<PortfolioTransactionsCubit,PortfolioTransactionsState>(
        builder: (context,state){
          ...
          Container(
            ...
            _transactionBody(state.transactions.length,state.transactions)
            ]
          )
        );  
    }
  ...
  _singleTransaction(
    ...
    return Container(
      decoration: const BoxDecoration(
        border: Border(
          bottom: BorderSide(width: 1.0, color: blurredGray)
        )),
      child: Column(
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
        Row(
          children: [
            Padding(
              ...
              child: Text(mapOfStocks[stockId]?.fullName.toUpperCase() ?? '',
            ...
            Column(
              ...
              children: [
               const Padding(
                ...
                Text(transactionTypeToStr(type),
                )
              ],
            ),
            Column(
